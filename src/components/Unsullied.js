...
class Unsullied extends Component {
    constructor(props) {
        super(props)
        this.state = {
            data: [],
    ...
    async componentDidMount() {
        ...
        // await fetch('http://localhost:3009/walkers?type=unsul', {
            await fetch(`${API_URL}walkers?type=unsul`, {
...
export default withRouter(Unsullied)